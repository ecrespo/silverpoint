...
import { barChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type BarChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpBarChart` (REQ-064): the same props as React's `BarChart`, name for name (API Spec §4). */
...
const recipe = barChart as ChartRecipe<CommonChartProps>;
