...
import { volvelleChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type VolvelleChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpVolvelleChart` (REQ-090): the same props as React's `VolvelleChart`, name for name (API Spec §4). */
const props = defineProps<VolvelleChartProps>();
...
const recipe = volvelleChart as ChartRecipe<CommonChartProps>;
