...
import { bubbleChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type BubbleChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpBubbleChart` (REQ-083): the same props as React's `BubbleChart`, name for name (API Spec §4). */
...
const recipe = bubbleChart as ChartRecipe<CommonChartProps>;
