...
import { chordRing, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type ChordRingProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpChordRing` (REQ-091): the same props as React's `ChordRing`, name for name (API Spec §4). */
const props = defineProps<ChordRingProps>();
...
const recipe = chordRing as ChartRecipe<CommonChartProps>;
