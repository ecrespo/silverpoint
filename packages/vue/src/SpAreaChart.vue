...
import { areaChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type AreaChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpAreaChart` (REQ-072): the same props as React's `AreaChart`, name for name (API Spec §4). */
...
const recipe = areaChart as ChartRecipe<CommonChartProps>;
