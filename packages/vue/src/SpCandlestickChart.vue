...
import { candlestickChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type CandlestickChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpCandlestickChart` (REQ-071): the same props as React's `CandlestickChart`, name for name (API Spec §4). */
const props = defineProps<CandlestickChartProps>();
...
const recipe = candlestickChart as ChartRecipe<CommonChartProps>;
