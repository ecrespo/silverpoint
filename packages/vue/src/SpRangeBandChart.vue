...
import { rangeBandChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type RangeBandChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpRangeBandChart` (REQ-073): the same props as React's `RangeBandChart`, name for name (API Spec §4). */
const props = defineProps<RangeBandChartProps>();
...
const recipe = rangeBandChart as ChartRecipe<CommonChartProps>;
