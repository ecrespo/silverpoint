...
import { windRose, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type WindRoseProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpWindRose` (REQ-089): the same props as React's `WindRose`, name for name (API Spec §4). */
const props = defineProps<WindRoseProps>();
...
const recipe = windRose as ChartRecipe<CommonChartProps>;
