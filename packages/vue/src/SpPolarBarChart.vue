...
import { polarBarChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type PolarBarChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpPolarBarChart` (REQ-077): the same props as React's `PolarBarChart`, name for name (API Spec §4). */
const props = defineProps<PolarBarChartProps>();
...
const recipe = polarBarChart as ChartRecipe<CommonChartProps>;
