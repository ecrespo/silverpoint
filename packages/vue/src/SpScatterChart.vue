...
import { scatterChart, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type ScatterChartProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpScatterChart` (REQ-082): the same props as React's `ScatterChart`, name for name (API Spec §4). */
...
const recipe = scatterChart as ChartRecipe<CommonChartProps>;
