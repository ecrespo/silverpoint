...
import { gaugeArc, type ActiveItem, type ChartHandle, type ChartRecipe, type CommonChartProps, type GaugeArcProps, type Readout } from '@silverpoint/core';
import { ref } from 'vue';
import ChartShell from './ChartShell.vue';

/** `SpGaugeArc` (REQ-080): the same props as React's `GaugeArc`, name for name (API Spec §4). */
const props = defineProps<GaugeArcProps>();
...
const recipe = gaugeArc as ChartRecipe<CommonChartProps>;
