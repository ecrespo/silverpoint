...
import { BENCH_CONTEXT, HUNDRED_POINTS, POLAR_AT_CEILING } from './hundred-points';
 ...
 * on time.
 */
for (const [chart, { recipe, props }] of Object.entries({ ...HUNDRED_POINTS, ...POLAR_AT_CEILING })) {
