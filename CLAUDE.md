...
- The parity gate **parses and compares trees**; it never normalises strings.
...
| Artifact | Status |
|---|---|
| Constitution | ✅ v1.2 ratified |
| PRD (EARS criteria) | ✅ v1.5 approved — 101 requirements, REQ-001..REQ-184 |
| API Spec | ✅ v1.3 approved — 33 components, 13 diagnostic codes |
| Technical Design | ✅ v1.2 approved — 10 decisions, DD-001..DD-010 |
| Data Model | ✅ v1.1 approved — verified palette, 9 invariants |
| Implementation Plan | ✅ v1.1 — 5 phases grouped by shared engine |
| Tasks | ✅ Phase 0 — 27 tasks, supervised first batch T-001..T-004 |
| Analyze | ✅ Second run — **READY TO IMPLEMENT**, 3 LOW findings open |
